            ...
            <div className="mx-auto flex max-w-7xl flex-col space-y-14">
                ...
                <main className="admin-main">
                    ...
                    <section className="admin-stat">
                        ...
                        <StatCard type="pending" count={appointments.pendingCount} label="Pending Appointments"
                            icon="/assets/icons/pending.svg" />
                        <StatCard type="cancelled" count={appointments.cancelledCount} label="Cancelled appointments"
